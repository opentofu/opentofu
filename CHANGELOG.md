...
* Fix regression in ignoring GPG signing key expiration by default ([822](https://github.com/opentofu/opentofu/issues/822))
  - Added experimental env variable to enable GPG signing key expiration `OPENTOFU_ENFORCE_GPG_EXPIRATION=true`
