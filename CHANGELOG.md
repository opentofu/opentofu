...
* Upgrade aws-sdk version to include `mx-central-1` region. Also, `skip_s3_checksum=true` now blocks the [aws-sdk new default S3 integrity checks](https://github.com/aws/aws-sdk-go-v2/discussions/2960)([#2596](https://github.com/opentofu/opentofu/pull/2596))
...
- Do not allow aws-sdk to control the checksum headers for the lock object but instead calculate it before doing the request. ([#2606](https://github.com/opentofu/opentofu/pull/2606))
