...
* Mocking a resource for `tofu test` now nullifies correctly the write-only attributes. ([#3964](https://github.com/opentofu/opentofu/issues/3964))
...
* azure backend: resolve OIDC token dynamically to support ADO refresh. ([#3594](https://github.com/opentofu/opentofu/pull/3594))
