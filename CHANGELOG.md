...
- Fix the way `key_provider` is decoded from the state encryption to allow the same functionality for json configuration files ([#3654](https://github.com/opentofu/opentofu/issues/3654))
