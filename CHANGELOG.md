...
* The S3 state backend now supports `tags` and `metadata` parameters for specifying tags and metadata on the state object in S3. [#3038](https://github.com/opentofu/opentofu/pull/3038)
