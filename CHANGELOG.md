...
- Fix loading only the necessary encryption key_providers and methods for better terraform_remote_state data support. ([2551](https://github.com/opentofu/opentofu/issues/2551))
