...
* Added support to resolve the issue of referencing output from a test run in the local variables block (tofu test). ([#1254](https://github.com/opentofu/opentofu/pull/1254))
