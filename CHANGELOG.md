...
ENHANCEMENTS:
* State encryption key providers now support customizing the metadata key via `encrypted_metadata_key` ([#1605](https://github.com/opentofu/opentofu/issues/1605))
