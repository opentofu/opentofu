...
- Deprecated attributes and blocks in resources now produce warnings when utilized. They can be filtered/disabled with the `-deprecation=` argument. ([#3973](https://github.com/opentofu/opentofu/pull/3973/))
