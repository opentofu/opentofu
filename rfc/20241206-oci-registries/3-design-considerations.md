...
Therefore, we have decided to use a layout that does not indicate a container image. See the [Providers](providers.md) document for details on the image layout.
