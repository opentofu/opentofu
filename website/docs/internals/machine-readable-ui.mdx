...
- `test_abstract`: the number of tests files and tests found
- `test_file`: the overall status of all tests executed within a test file
- `test_run`: the status of a test run
- `test_summary`: the overall status and aggregated statistics of all tests executed

## Test Abstract

The `test_abstract` message `test_abstract` object contains keys composed of test file names:

- `test file`: a list of tests contained within the test file
...
- `path`: the relative path to the test file executed
- `status`: the overall status of all tests executed within the test file
...
- `path`: the relative path to the test file executed
- `run`: the name of the test which was executed
...
- `passed`: the aggregated amount of tests passed
- `failed`: the aggregated amount of tests failed
- `errored`: the aggregated amount of tests errored
- `skipped`: the aggregated amount of tests skipped
