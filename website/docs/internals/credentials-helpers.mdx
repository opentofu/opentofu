...
[default plugin search locations](/docs/plugin/how-tofu-works#plugin-locations).
...
one of the [default plugin search locations](/docs/plugin/how-tofu-works#plugin-locations).
