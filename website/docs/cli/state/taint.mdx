...
still running then OpenOpenTofu will typically have no way to detect and respond
...
after which OpenOpenTofu will consider the object to be ready for use by any
