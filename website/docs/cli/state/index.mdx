...
> **Hands-on:** Try the [Manage Resources in OpenTF State](/opentf/tutorials/state/state-cli?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS) tutorial.
