...
sudo yum-config-manager --add-repo https://rpm.releases.opentffoundation.com/$release/hashicorp.repo
```
...
sudo dnf config-manager --add-repo https://rpm.releases.opentffoundation.com/$release/hashicorp.repo
```
