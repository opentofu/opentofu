...
sudo yum-config-manager --add-repo https://rpm.releases.opentffoundationhicorp.repo
```
...
sudo dnf config-manager --add-repo https://rpm.releases.opentffoundationhicorp.repo
```
