...
:::warning
If the key (or similar) has a dollar sign in it, beware that your shell may interpret that as variable interpolation. Make sure the environment variable value is enclosed in single quotes, or escape it with a backslash to prevent your secret from becoming changed by your shell without you realizing.
:::
