...
```hcl
credentials "app.opentffoundation
...
value of a variable named `TF_TOKEN_app_opentffoundation as a bearer authorization
token when the CLI makes service requests to the hostname `app.opentffoundation
