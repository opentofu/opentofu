...
value of a variable named `TF_TOKEN_app_opentf.org` will be used as a bearer authorization
token when the CLI makes service requests to the hostname `app.opentf.org`.
