...
For configurations using the [Terraform Cloud CLI integration](/opentf/cli/cloud) or the [`remote` backend](/opentf/language/settings/backends/remote) only, `opentf taint`
