...
:::warning
It is possible to use this feature in non-interactive scripts, however it is not recommended.
`tofu console` is not designed with machine-driven expression evaluation in mind.
:::
