...
> **Hands-on:** Try the [OpenTF: Get Started](/opentf/tutorials/aws-get-started?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS) tutorials. For more in-depth details on the `plan` command, check out the [Create a OpenTF Plan tutorial](/opentf/tutorials/cli/plan?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS).
...
> **Hands-on:** Try the [Use Refresh-Only Mode to Sync OpenTF State](/opentf/tutorials/state/refresh) tutorial.
...
> **Hands-on:** Try the [Target resources](/opentf/tutorials/state/resource-targeting?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS) tutorial.
