...
that OpenOpenTofu will find those files automatically without any extra arguments.
...
There are two exceptions where OpenOpenTofu will use the original working directory
