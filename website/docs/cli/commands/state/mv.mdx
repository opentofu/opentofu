...
OpenOpenTofu will look in the current state for a resource instance, resource,
...
object but tracking it under a new name. By default OpenOpenTofu will understand
