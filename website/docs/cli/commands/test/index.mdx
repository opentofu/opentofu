...
`mock_resource` and `mock_data` blocks override all instances of the entire resource type. If you want to override a specific instance of a resource, use the `override_resource` or `override_data` blocks.
