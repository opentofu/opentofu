...
#### Ephemeral variables
As ephemeral variables can not be stored within in a planfile, any ephemeral variables set during the generation of a planfile from tofu plan must also be set when running tofu apply.
