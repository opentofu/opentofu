...
TACOS (TF Automation and Collaboration Software) are platforms that perform
...
front-end for CLI-driven runs, and can also use some TACOS as a state backend and a private module
