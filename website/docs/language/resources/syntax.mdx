...
[Provider Registry](https://registry.terraform.io/browse/providers), which also
...
[the Provider Registry](https://registry.terraform.io/browse/providers).
...
might still be hosted here, the Provider Registry is now the main home for all
