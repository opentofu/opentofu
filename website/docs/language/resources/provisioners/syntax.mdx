...
> **Hands-on:** Try the [Provision Infrastructure with Cloud-Init](/opentf/tutorials/provision/cloud-init?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS) tutorial.
