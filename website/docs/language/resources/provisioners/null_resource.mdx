...
Instances of [`terraform_data`](/docs/language/resources/tf-data) are treated
like normal resources, but they don't do anything. Like with any other resource
type, you can configure [provisioners](/docs/language/resources/provisioners/syntax)
and [connection details](/docs/language/resources/provisioners/connection) on a
