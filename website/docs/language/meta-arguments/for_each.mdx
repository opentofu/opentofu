...
Though, in context of `ephemeral` blocks, sensitive and ephemeral values can be used in the
expressions for the `for_each` meta argument since the ephemeral resources information will not
be stored in plan or state.
