...
As described in [Provider Configuration](/docs/language/providers/configuration), you can optionally
...
[a `<PROVIDER>.<ALIAS>` reference](/docs/language/providers/configuration#referring-to-alternate-provider-configurations),
