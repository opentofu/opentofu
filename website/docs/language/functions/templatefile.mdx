...
OpenOpenTofu will not prevent you from using other names, but following this
...
achieved by using a
[`for` expression](/docs/language/expressions/for)
rather than by using
[template directives](/docs/language/expressions/strings#directives).
