...
for use within [Custom Conditions](/docs/language/expressions/custom-conditions)
as a way to validate time sensitive resources such as TLS certificates.

There are circumstances, such as during an OpenTofu [Refresh-only](/docs/cli/commands/plan#planning-modes) plan, where
