...
[OpenTofu language values](/docs/language/expressions/types)
...
- [`jsondecode`](/docs/language/functions/jsondecode) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](/docs/language/functions/yamlencode) performs the opposite operation, _encoding_
  a value as YAML.
