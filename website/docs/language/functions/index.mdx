...
> **Hands-on:** Try the [Perform Dynamic Operations with Functions](/opentf/tutorials/configuration-language/functions?utm_source=WEBSITE&utm_medium=WEB_IO&utm_offer=ARTICLE_PAGE&utm_content=DOCS) tutorial.
