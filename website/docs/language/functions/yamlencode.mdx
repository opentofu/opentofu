...
JSON using [`jsonencode`](/opentf/language/functions/jsonencode) instead, even if
...
[`jsonencode`](/opentf/language/functions/jsonencode) instead: YAML flow-style is a superset
of JSON syntax.

## Related Functions

- [`jsonencode`](/opentf/language/functions/jsonencode) is a similar operation using JSON instead
  of YAML.
- [`yamldecode`](/opentf/language/functions/yamldecode) performs the opposite operation, _decoding_
