...
related function [`cidrsubnet`](/docs/language/functions/cidrsubnet). `cidrsubnet` calculates
...
* [`cidrsubnet`](/docs/language/functions/cidrsubnet) calculates a single subnet address, allowing
