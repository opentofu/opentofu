...
as [`base64decode`](/docs/language/functions/base64decode).
...
* [`textencodebase64`](/docs/language/functions/textencodebase64) performs the opposite operation,
  applying target encoding and then Base64 to a string.
* [`base64decode`](/docs/language/functions/base64decode) is effectively a shorthand for
