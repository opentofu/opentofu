...
All of the arguments must be of the same type. OpenOpenTofu will try to
...
* [`coalescelist`](/docs/language/functions/coalescelist) performs a similar operation with
