...
[`yamlencode`](../../language/functions/yamlencode.mdx), specifying the value to encode using [standard OpenTofu expression syntax](../../language/expressions.mdx) as in the following examples:
