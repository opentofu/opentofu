...
* Files named exactly `opentf.tfvars`, `opentf.tfvars.json`, `terraform.tfvars` or `terraform.tfvars.json`.
* Any files with names ending in `.auto.tfvars` or `.auto.tfvars.json`.
* Note: `opentf.tfvars` and `opentf.tfvars.json` will take precedence over `terraform.tfvars` or `terraform.tfvars.json` respectively.
...
* Environment variables
* The `opentf.tfvars` or `terraform.tfvars` file, if present and in this respective order.
* The `opentf.tfvars.json` or `terraform.tfvars.json` file, if present and in this respective order.
