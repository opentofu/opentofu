...
The `required_version` setting accepts a
[version constraint string](../../language/expressions/version-constraints.mdx),
which specifies which versions of OpenTofu can be used with your configuration.
