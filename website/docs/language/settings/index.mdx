...
- `backend` blocks represent [backend configuration](../../language/settings/backends/configuration.mdx).
- `cloud` blocks represent [cloud configuration](../../language/settings/tf-cloud.mdx).
- `required_providers` blocks represent [provider requirements](../../language/providers/requirements.mdx).
