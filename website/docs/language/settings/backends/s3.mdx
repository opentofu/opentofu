...
## Bootstrap the backend using Amazon CloudFormation

Amazon provides a sample repository for bootstrapping the backend with Amazon CloudFormation, accessible at the following link: [bootstrap-amazon-s3-remote-backend-for-open-tofu
](https://github.com/aws-samples/bootstrap-amazon-s3-remote-backend-for-open-tofu).
