...
This backend supports state locking by making use of [conditional writes](https://docs.aws.amazon.com/AmazonS3/latest/userguide/conditional-writes.html) with `If-None-Match` header.
Enable this functionality by setting `use_lockfile=true`.
:::info
