...
In order to enable more granular lifecycle rules on the objects OpenTofu stores in the configured S3 bucket, two attributes that can be used to tag the objects with the desired tags.
#### State object tags
