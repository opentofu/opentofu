...
A backend defines where OpenTofu stores its [state](../../../language/state.mdx) data files.
...
The local backend configuration is different and entirely separate from the `terraform.tfstate` file that contains [state data](../../../language/state.mdx) about your real-world infrastruture. OpenTofu stores the `terraform.tfstate` file in your remote backend.
...
provided as part of [the initialization process](../../../cli/init.mdx).
...
and request a [reinitialization](../../../cli/init.mdx). As part of
...
change and prompt you to [reinitialize](../../../cli/init.mdx).
