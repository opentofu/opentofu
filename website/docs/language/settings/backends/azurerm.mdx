...
* `client_certificate` - (Optional) A Base64-encoded PKCS#12 certificate used as the Client Certificate when authenticating as a Service Principal. This can also be sourced from the `ARM_CLIENT_CERTIFICATE` environment variable.
