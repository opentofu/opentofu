...
[opentf state](/docs/cli/commands/state) command to perform
...
* [The `opentf output` command](/docs/cli/commands/output)
...
* [The `opentf show` command](/docs/cli/commands/show) has a `-json`
