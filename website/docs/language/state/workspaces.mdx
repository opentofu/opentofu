...
Each OpenTF configuration has an associated [backend](/docs/language/settings/backends/configuration) that defines how OpenTF executes operations and where OpenTF stores persistent data, like [state](/docs/language/state/purpose).
