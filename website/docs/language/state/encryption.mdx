...
import ConfigurationPartialTF from '!!raw-loader!./examples/encryption/configuration_mixed.tf'
import ConfigurationSH from '!!raw-loader!./examples/encryption/configuration.sh'
import ConfigurationPartialSH from '!!raw-loader!./examples/encryption/configuration_mixed.sh'
