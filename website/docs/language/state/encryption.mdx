...
If you decide for a key management system, please make sure to configure regular key rotation. This is especially important if the chosen encryption method can exhaust the key. (This is not a problem with passphrase-based static keys.) You can find more information in the [encryption methods](#encryption-methods) section below.
