...
// Input describes the input data structure. This is only present if existing data needs to be decrypted,
// but not present if no existing data needs to be decrypted.
type Input struct {
