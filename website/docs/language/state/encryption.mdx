...
import ConfigurationPartialTF from '!!raw-loader!./examples/encryption/configuration_partial.tf'
import ConfigurationPartialSH from '!!raw-loader!./examples/encryption/configuration_partial.sh'
import ConfigurationPartialPS1 from '!!raw-loader!./examples/encryption/configuration_partial.ps1'
...
The basic configuration structure using a single method looks as follows:
...
<Tabs>
    <TabItem value="code" label="Partial Code" default>
        <CodeBlock language={"hcl"}>{ConfigurationPartialTF}</CodeBlock>
    </TabItem>
    <TabItem value="env-sh" label="Environment (Linux/UNIX shell) - key_provider block">
        <CodeBlock language={"shell"}>{ConfigurationPartialSH}</CodeBlock>
    </TabItem>
    <TabItem value="env-ps1" label="Environment (Powershell) - key_provider block">
        <CodeBlock language={"powershell"}>{ConfigurationPartialPS1}</CodeBlock>
    </TabItem>
</Tabs>
