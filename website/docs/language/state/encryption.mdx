...
import ExternalCommandHeader from '!!raw-loader!./examples/encryption/externalcommand-header.json'
import ExternalCommandInput from '!!raw-loader!./examples/encryption/externalcommand-input.json'
import ExternalCommandOutput from '!!raw-loader!./examples/encryption/externalcommand-output.json'
import ExternalCommandGo from '!!raw-loader!./examples/encryption/externalcommand-provider.go'
import ExternalCommandPython from '!!raw-loader!./examples/encryption/externalcommand-provider.py'
import ExternalCommandSH from '!!raw-loader!./examples/encryption/externalcommand-provider.sh'
...
<Tabs>
    <TabItem value="step1" label="Step 1: Writing the header" default>
        ...
        <CodeBlock language={"json"}>{ExternalCommandHeader}</CodeBlock>
        <Button
    ...
    <TabItem value="step2" label="Step 2: Reading the input">
        ...
        <CodeBlock language={"json"}>{ExternalCommandInput}</CodeBlock>
        <Button
    ...
    <TabItem value="step3" label="Step 3: Writing the output">
        ...
        <CodeBlock language={"json"}>{ExternalCommandOutput}</CodeBlock>
        <Button
    ...
    <TabItem value="example-go" label="Example: Go">
        <CodeBlock language={"go"}>{ExternalCommandGo}</CodeBlock>
    </TabItem>
    <TabItem value="example-python" label="Example: Python">
        <CodeBlock language={"python"}>{ExternalCommandPython}</CodeBlock>
    </TabItem>
    <TabItem value="example-sh" label="Example: POSIX Shell">
        <CodeBlock language={"sh"}>{ExternalCommandSH}</CodeBlock>
    </TabItem>
</Tabs>
