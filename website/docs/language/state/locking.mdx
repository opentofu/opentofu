...
If supported by your [backend](/docs/language/settings/backends/configuration), OpenTF will lock your
...
OpenTF has a [force-unlock command](/docs/cli/commands/force-unlock)
