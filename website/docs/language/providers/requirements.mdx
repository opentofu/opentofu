...
[`opentf` block](/opentf/language/settings) (which can also contain other settings).
...
[the `opentf_remote_state` data source](/opentf/language/state/remote-state-data).
