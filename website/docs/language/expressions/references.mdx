...
`<RESOURCE TYPE>.<NAME>` represents a [managed resource](../../language/resources.mdx) of
...
[data resource](../../language/data-sources.mdx) of the given data
...
If you use [`dynamic` blocks](dynamic-blocks/index.mdx) to dynamically generate
...
OpenTofu will still record sensitive values in the [state](../../language/state.mdx),
