...
declaration, OpenOpenTofu will automatically convert the caller's given value
...
certain attributes as _sensitive_, in which case OpenOpenTofu will show a
...
where OpenOpenTofu will hide the value in the plan and apply messages and will
...
[Cases where OpenTofu may disclose a sensitive variable](/docs/language/values/variables#cases-where-tofu-may-disclose-a-sensitive-variable).
...
* OpenOpenTofu will attempt to validate that unknown values are of suitable
