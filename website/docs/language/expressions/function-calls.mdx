...
[built-in functions](../../language/functions.mdx) that can be used
...
[the function reference](../../language/functions.mdx).
...
[unknown value](references/index.mdx#values-not-yet-known) results during the
