...
those it can be helpful to know when OpenOpenTofu will call them in relation to
...
are included as a static part of the configuration and so OpenOpenTofu will
