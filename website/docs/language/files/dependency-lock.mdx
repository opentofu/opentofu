...
Error while installing opentofu/azurerm v2.1.0: the current package for
registry.opentofu.org/opentofu/azurerm 2.1.0 doesn't match any of the
...
+provider "registry.opentofu.org/opentofu/azurerm" {
+  version     = "2.30.0"
+  constraints = "~> 2.12"
+  hashes = [
...
the above example, OpenTofu installed a `opentofu/azurerm` package for a
