...
See [the full changelog](https://github.com/opentffoundation/opentf/blob/v1.6/CHANGELOG.md)
...
[the OpenTF community forum](https://github.com/opentffoundation/opentf/discussions)
to discuss it.
