...
- [Module Blocks](/docs/language/modules/syntax) documents the syntax for
  calling a child module from a parent module, including meta-arguments like
  `for_each`.

- [Module Sources](/docs/language/modules/sources) documents what kinds of paths,
...
- The Meta-Arguments section documents special arguments that can be used with
  ...
  [`providers`](/docs/language/meta-arguments/module-providers),
...
[Module Development](/docs/language/modules/develop).
