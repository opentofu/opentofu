...
To learn how to _use_ modules, see [the Modules configuration section](../../../language/modules.mdx).
...
[configuration language](../../../language.mdx) concepts we use in root modules.
...
* [Resources](../../../language/resources.mdx) to define one or more
