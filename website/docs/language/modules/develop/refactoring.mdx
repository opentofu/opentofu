...
Later, you use [`for_each`](/docs/language/meta-arguments/for_each) with this
...
[`count`](/docs/language/meta-arguments/count) with this resource to systematically
...
When at least one of the two addresses includes an instance key, like
`[2]` in the above example, OpenOpenTofu will understand both addresses as
...
[module package](/docs/language/modules/sources#modules-in-package-sub-directories).
