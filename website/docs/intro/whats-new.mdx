...
- [New features](#new-features)
  ...
  - [Moved now supports migration between different types](#moved-now-supports-migration-between-different-types)
...
- `moved` block can now be used to migrate between different types of resources ([docs](../../language/modules/develop/refactoring/#changing-a-resource-type)).
