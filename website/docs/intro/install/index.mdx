...
<DocCardList
    items={[
        ...
        },
        {
            ...
            label: "FreeBSD",
            description:
                "Install OpenTofu from the FreeBSD ports and packages system.",
        },
        {
            type: "link",
            href: "fedora/",
        ...
        },
        {
            type: "link",
            href: "homebrew/",
            label: "Linux (Homebrew)",
            description: "Install OpenTofu on Linux using Homebrew.",
        },
        {
            type: "link",
            href: "macos/",
            label: "MacOS",
            description: "Install OpenTofu on MacOS.",
        },
        {
            type: "link",
            href: "windows/",
