...
<DocCardList
  items={[
    ...
    },
    {
      ...
      description: "Install OpenTofu on RHEL, Fedora, openSUSE, AlmaLinux or any other .rpm-based Linux distribution using your package manager.",
    },
    {
      type: "link",
      href: "/docs/intro/install/fedora",
      label: "Fedora",
      description: "Install OpenTofu on Fedora using your package manager.",
    },
    {
      type: "link",
