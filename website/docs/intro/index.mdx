...
![OpenTofu creates and manages cloud platforms and services through their APIs](/img/docs/intro-tofu-apis.png)
...
- **Apply:** On approval, OpenTofu performs the proposed operations in the correct order, respecting any resource dependencies. For example, if you update the properties of a VPC and change the number of virtual machines in that VPC, OpenOpenTofu will recreate the VPC before scaling the virtual machines.

![The OpenTofu workflow has three steps: Write, Plan, and Apply](/img/docs/intro-tofu-workflow.png)
