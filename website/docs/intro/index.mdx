...
- Ask questions in [OpenTF Discuss](https://github.com/opentffoundationns).
- Read our [contributing guide](https://github.com/opentffoundation/.github/CONTRIBUTING.md).
- [Submit an issue](https://github.com/opentffoundationw/choose) for bugs and feature requests.
