...
Although OpenTofu 1.6.2 is very similar to Terraform 1.6.6, it is a non-trivial change affecting your infrastructure.
Make sure you have an up to date and *tested* disaster recovery plan.
