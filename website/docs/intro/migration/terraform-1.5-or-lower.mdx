...
Although OpenTofu 1.6 is very similar to Terraform 1.5.7, it is a non-trivial change affecting your infrastructure. Make
...
## Step 8: Upgrade to the latest OpenTofu version
