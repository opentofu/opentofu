...
Although OpenTofu 1.7 is very similar to Terraform 1.7.5, it is a non-trivial change affecting your infrastructure. Make
...
2. If you are using `override_resource`, `override_data`, or `override_module`, restructure your tests to work without these features.
