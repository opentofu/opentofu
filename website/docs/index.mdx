...
Welcome to OpenTofu 1.9! This version brings you a host of new features like provider iteration, the `-exclude` flag and more. If you are coming from a previous OpenTofu or Terraform version you can [read the details about the new features here &raquo;](intro/whats-new.mdx)
