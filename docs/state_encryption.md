...
Furthermore, it is not a goal of this feature to *authenticate* the plan file. It does not protect against, among others, replay attacks where a malicious actor replaces a current plan or state file with an old one.
