...
* The name of the [workspace](https://opentf.org/docs/state/workspaces.html)
...
[backend](https://opentf.org/docs/backends/index.html). Each backend name
...
[OpenTF state](https://opentf.org/docs/language/state/index.html)
...
they switch to [remote state](https://opentf.org/docs/language/state/remote.html).
...
* [`ReferenceTransformer`](https://pkg.go.dev/github.com/opentffoundation/opentf/internal/opentf#ReferenceTransformer),
...
* [`ProviderTransformer`](https://pkg.go.dev/github.com/opentffoundation/opentf/internal/opentf#ProviderTransformer),
  ...
  [the inheritance rules](https://opentf.org/docs/language/modules/develop/providers.html))
