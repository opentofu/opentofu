...
func TestProviderReservedNames(t *testing.T) {
	...
	assertExactDiagnostics(t, diags, []string{
		...
		`config.tf:10,3-13: Reserved argument name in provider block; The provider argument name "depends_on" is reserved for use by OpenTofu in a future version.`,
		`config.tf:12,3-12: Reserved block type name in provider block; The block type name "lifecycle" is reserved for use by OpenTofu in a future version.`,
		`config.tf:13,3-9: Reserved block type name in provider block; The block type name "locals" is reserved for use by OpenTofu in a future version.`,
		`config.tf:11,3-9: Reserved argument name in provider block; The provider argument name "source" is reserved for use by OpenTofu in a future version.`,
	})
}
