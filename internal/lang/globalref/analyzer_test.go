...
func testAnalyzer(t *testing.T, fixtureName string) *Analyzer {
	...
	_, instDiags := inst.InstallModules(context.Background(), configDir, "tests", true, false, initwd.ModuleInstallHooksImpl{}, configs.StaticModuleCall{})
	...
	cfg, loadDiags := loader.LoadConfig(configDir, configs.StaticModuleCall{})
