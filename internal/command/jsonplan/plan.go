...
const (
	...
	ResourceInstanceForgottenBecauseOfLifecycleDestroyInState = "forgotten_because_of_lifecycle_destroy_in_state"
)
...
func MarshalResourceChanges(resources []*plans.ResourceInstanceChangeSrc, schemas *tofu.Schemas) ([]ResourceChange, error) {
	...
	for _, rc := range sortedResources {
		...
		case plans.ResourceInstanceForgottenBecauseOfLifecycleDestroyInState:
			r.ActionReason = ResourceInstanceForgottenBecauseOfLifecycleDestroyInState
		default:
