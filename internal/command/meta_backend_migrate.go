...
Please use the API to do this: https://opentf.org/docs/cloud/api/state-versions.html
`
...
For more information on workspace naming, see https://opentf.org/docs/cloud/workspaces/naming.html
