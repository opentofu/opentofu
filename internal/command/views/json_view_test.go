...
func TestJSONView_PlannedChange(t *testing.T) {
	...
	jv.PlannedChange(jsondiagnostic.NewResourceInstanceChange(cs))
...
func TestJSONView_ResourceDrift(t *testing.T) {
	...
	jv.ResourceDrift(jsondiagnostic.NewResourceInstanceChange(cs))
...
func TestJSONView_Outputs(t *testing.T) {
	...
	jv.Outputs(jsondiagnostic.Outputs{
		"boop_count": {
			Sensitive: false,
