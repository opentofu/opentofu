...
func (v *ValidateJSON) Results(diags tfdiags.Diagnostics) int {
	...
	type Output struct {
		...
		Diagnostics  []*jsondiagnostic.Diagnostic `json:"diagnostics"`
	}
	...
	for _, diag := range diags {
		output.Diagnostics = append(output.Diagnostics, jsondiagnostic.NewDiagnostic(diag, configSources))
	...
	if output.Diagnostics == nil {
		...
		output.Diagnostics = []*jsondiagnostic.Diagnostic{}
	}
