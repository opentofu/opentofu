...
func testTaintHuman(t *testing.T, call func(v Taint), wantStdout, wantStderr string) {
	...
	v := NewTaint(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(v)
	output := done(t)
...
func testTaintJson(t *testing.T, call func(v Taint), want []map[string]interface{}) {
	view, done := testView(t)
	v := NewTaint(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(v)
	output := done(t)
	if output.Stderr() != "" {
...
func testTaintMulti(t *testing.T, call func(v Taint), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	v := NewTaint(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(v)
	{
