...
func testConsoleHuman(t *testing.T, call func(console Console), wantStdout, wantStderr string) {
	...
	consoleView := NewConsole(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(consoleView)
	output := done(t)
...
func testConsoleMulti(t *testing.T, call func(console Console), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	consoleView := NewConsole(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(consoleView)
	{
