...
func TestTestHuman_Conclusion(t *testing.T) {
	...
	for name, tc := range tcs {
		t.Run(name, func(t *testing.T) {
			...
			view := NewTest(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, NewView(streams))
...
func TestTestJSON_Abstract(t *testing.T) {
	...
	for name, tc := range tcs {
		t.Run(name, func(t *testing.T) {
			streams, done := terminal.StreamsForTesting(t)
			view := NewTest(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, NewView(streams))
