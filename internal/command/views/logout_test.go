...
func testLogoutHuman(t *testing.T, call func(logout Logout), wantStdout, wantStderr string) {
	...
	logoutView := NewLogout(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(logoutView)
	output := done(t)
...
func testLogoutJson(t *testing.T, call func(logout Logout), want []map[string]interface{}) {
	view, done := testView(t)
	logoutView := NewLogout(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(logoutView)
	output := done(t)
	if output.Stderr() != "" {
...
func testLogoutMulti(t *testing.T, call func(logout Logout), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	logoutView := NewLogout(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(logoutView)
	{
