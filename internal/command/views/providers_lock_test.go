...
func testProvidersLockHuman(t *testing.T, call func(v ProvidersLock), wantStdout, wantStderr string) {
	...
	v := NewProvidersLock(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(v)
	output := done(t)
...
func testProvidersLockJson(t *testing.T, call func(v ProvidersLock), want []map[string]interface{}) {
	view, done := testView(t)
	v := NewProvidersLock(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(v)
	output := done(t)
	if output.Stderr() != "" {
...
func testProvidersLockMulti(t *testing.T, call func(v ProvidersLock), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	v := NewProvidersLock(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(v)
	{
