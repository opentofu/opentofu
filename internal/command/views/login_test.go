...
func testLoginHuman(t *testing.T, call func(login Login), wantStdout, wantStderr string) {
	...
	loginView := NewLogin(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(loginView)
	output := done(t)
...
func testLoginJson(t *testing.T, call func(login Login), want []map[string]any) {
	view, done := testView(t)
	loginView := NewLogin(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(loginView)
	output := done(t)
	if output.Stderr() != "" {
...
func testLoginMulti(t *testing.T, call func(login Login), wantStdout string, wantStderr string, want []map[string]any) {
	...
	view, done := testView(t)
	loginView := NewLogin(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(loginView)
	{
