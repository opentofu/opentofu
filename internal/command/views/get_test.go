...
func testGetHuman(t *testing.T, call func(get Get), wantStdout, wantStderr string) {
	...
	getView := NewGet(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(getView)
	output := done(t)
...
func testGetJson(t *testing.T, call func(get Get), want []map[string]interface{}) {
	view, done := testView(t)
	getView := NewGet(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(getView)
	output := done(t)
	if output.Stderr() != "" {
...
func testGetMulti(t *testing.T, call func(get Get), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	getView := NewGet(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(getView)
	{
