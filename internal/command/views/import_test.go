...
func testImportHuman(t *testing.T, call func(v Import), wantStdout, wantStderr string) {
	...
	v := NewImport(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	call(v)
	output := done(t)
...
func testImportJson(t *testing.T, call func(v Import), want []map[string]interface{}) {
	...
	view, done := testView(t)
	v := NewImport(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
	call(v)
	output := done(t)
	if output.Stderr() != "" {
...
func testImportMulti(t *testing.T, call func(v Import), wantStdout string, wantStderr string, want []map[string]interface{}) {
	...
	view, done := testView(t)
	v := NewImport(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
	call(v)
	{
