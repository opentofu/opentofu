...
func TestInitViews_Hooks(t *testing.T) {
	t.Run("hooks_human_withLocalPath", func(t *testing.T) {
		view, _ := testView(t)
		initView := NewInit(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view)
	...
	t.Run("hooks_json", func(t *testing.T) {
		view, _ := testView(t)
		initView := NewInit(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view)
		hooks := initView.Hooks(true)
	...
	t.Run("hooks_multi", func(t *testing.T) {
		...
		view, _ := testView(t)
		initView := NewInit(&arguments.View{ViewType: arguments.ViewHuman, JSONInto: jsonInto, NoColor: true}, view)
		hooks := initView.Hooks(true)
