...
`,
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			v := NewOutput(&arguments.View{ViewType: arguments.ViewHuman}, NewView(streams))
...
func TestOutput_sensitive(t *testing.T) {
	...
	for name, vt := range testCases {
		t.Run(name, func(t *testing.T) {
			streams, done := terminal.StreamsForTesting(t)
			v := NewOutput(&arguments.View{ViewType: vt}, NewView(streams))
...
`,
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			streams, done := terminal.StreamsForTesting(t)
			v := NewOutput(&arguments.View{ViewType: tc.vt}, NewView(streams))
...
func TestOutputJSON_empty(t *testing.T) {
	streams, done := terminal.StreamsForTesting(t)
	v := NewOutput(&arguments.View{ViewType: arguments.ViewJSON}, NewView(streams))
...
func TestOutputRaw(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			streams, done := terminal.StreamsForTesting(t)
			v := NewOutput(&arguments.View{ViewType: arguments.ViewRaw}, NewView(streams))
