	...
	tests := map[string]struct {
		...
		"remote deprecated output attribute with all level": {
			diag: tfdiags.Diagnostics{}.Append(tfdiags.Override(
				...
				tfdiags.Warning,
				marks.DeprecatedOutputDiagnosticOverride(marks.DeprecationCause{Module: remotePath.String()}),
			)),
		...
		"local deprecated output attribute with all level": {
			diag: tfdiags.Diagnostics{}.Append(tfdiags.Override(
				tfdiags.AttributeValue(tfdiags.Warning, "summary", "details", nil),
				tfdiags.Warning,
				marks.DeprecatedOutputDiagnosticOverride(marks.DeprecationCause{Module: localPath.String()}),
			)),
			lvl:  arguments.DeprecationWarningLevelAll,
			want: true,
		},
		...
		"remote variable with all level": {
			diag: tfdiags.Diagnostics{}.Append(&hcl.Diagnostic{
				Extra: tofu.VariableDeprecationCause{IsFromRemoteModule: true},
			}),
			lvl:  arguments.DeprecationWarningLevelAll,
			want: true,
		},
		...
		"local variable with all level": {
			diag: tfdiags.Diagnostics{}.Append(&hcl.Diagnostic{
				Extra: tofu.VariableDeprecationCause{IsFromRemoteModule: false},
			}),
			lvl:  arguments.DeprecationWarningLevelAll,
			want: true,
		},
