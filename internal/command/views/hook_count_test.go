...
func TestCountHookPostDiff_DestroyDeposed(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(addr, states.DeposedKey("deadbeef"), plans.Delete, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookPostDiff_DestroyOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(addr, states.CurrentGen, plans.Delete, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookPostDiff_AddOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(addr, states.CurrentGen, plans.Create, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookPostDiff_ChangeOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(addr, states.CurrentGen, plans.Update, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookPostDiff_Mixed(t *testing.T) {
	...
	for k, a := range resources {
		...
		h.PostDiff(addr, states.CurrentGen, a, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookPostDiff_NoChange(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(addr, states.CurrentGen, plans.NoOp, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
	}
...
func TestCountHookApply_ChangeOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PreApply(addr, states.CurrentGen, plans.Update, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
		h.PostApply(addr, states.CurrentGen, cty.DynamicVal, nil)                         //nolint:errcheck // nil only
	}
...
func TestCountHookApply_DestroyOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PreApply(addr, states.CurrentGen, plans.Delete, cty.DynamicVal, cty.DynamicVal) //nolint:errcheck // nil only
		h.PostApply(addr, states.CurrentGen, cty.DynamicVal, nil)                         //nolint:errcheck // nil only
	}
