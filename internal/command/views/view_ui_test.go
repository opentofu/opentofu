...
func TestViewUiHuman_OutputStreams(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ui := NewViewUI(&arguments.View{ViewType: arguments.ViewHuman, NoColor: true}, view, nil) // testing output only, no need for Ui
...
func TestViewUiJSON_OutputStreams(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			ui := NewViewUI(&arguments.View{ViewType: arguments.ViewJSON, NoColor: true}, view, nil)
