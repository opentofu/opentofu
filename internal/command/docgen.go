...
// docWriter is a collection of functions that are called from docGen to produce
// some form of usage text.
...
func DocgenCommander() Command {
	...
	cmd.Run = func(meta Meta) int {
		if docType != "man" {
			// Maybe this could support gnu infopages some day if we are feeling extra.
