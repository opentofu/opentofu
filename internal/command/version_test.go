...
func TestVersion(t *testing.T) {
	...
	expected := "OpenTF v4.5.6-foo\non aros_riscv64\n+ provider registry.opentf.org/hashicorp/test1 v7.8.9-beta.2\n+ provider registry.opentf.org/hashicorp/test2 v1.2.3"
	if actual != expected {
	...
	expected = strings.TrimSpace(`
{
  ...
  "platform": "aros_riscv64",
  "provider_selections": {
    "registry.opentf.org/hashicorp/test1": "7.8.9-beta.2",
    "registry.opentf.org/hashicorp/test2": "1.2.3"
  }
}
`)
	if diff := cmp.Diff(expected, actual); diff != "" {
