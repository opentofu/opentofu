...
func (c *UntaintCommand) Run(rawArgs []string) int {
	...
	args, closer, diags := arguments.ParseUntaint(rawArgs)
	defer closer()
	...
	view := views.NewUntaint(args.ViewOptions, c.View)
...
func (c *UntaintCommand) allowMissingExit(name addrs.AbsResourceInstance, view views.Untaint) int {
