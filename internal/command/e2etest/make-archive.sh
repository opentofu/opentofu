...
LDFLAGS="-X github.com/opentffoundation/opentf/internal/command/e2etest.terraformBin=./opentf$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/opentffoundation/opentf/internal/command/e2etest
