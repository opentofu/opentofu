...
func (s *ResourceState) ProviderAddr() (addrs.AbsProviderInstance, error) {
	...
	if travDiags.HasErrors() {
		return addrs.AbsProviderInstance{}, diags.Err()
	}

	addr, addrDiags := addrs.ParseAbsProviderInstance(traversal)
