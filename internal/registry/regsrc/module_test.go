...
func TestModule(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			source:      "opentofu/consul/aws",
			wantString:  "opentofu/consul/aws",
			wantDisplay: "opentofu/consul/aws",
			wantNorm:    "opentofu/consul/aws",
			wantErr:     false,
		},
		{
			name:        "public registry, submodule",
			source:      "opentofu/consul/aws//foo",
			wantString:  "opentofu/consul/aws//foo",
			wantDisplay: "opentofu/consul/aws//foo",
			wantNorm:    "opentofu/consul/aws//foo",
			wantErr:     false,
		},
		{
			name:        "public registry, explicit host",
			source:      "registry.opentofu.org/opentofu/consul/aws",
			wantString:  "registry.opentofu.org/opentofu/consul/aws",
			wantDisplay: "opentofu/consul/aws",
			wantNorm:    "opentofu/consul/aws",
			wantErr:     false,
		},
		...
		},
		{
			...
			source:      "Example.com:1234/OpenTofu/Consul/aws",
			wantString:  "Example.com:1234/OpenTofu/Consul/aws",
			wantDisplay: "example.com:1234/opentofu/consul/aws",
			wantNorm:    "example.com:1234/opentofu/consul/aws",
			wantErr:     false,
		},
		{
			name:        "IDN registry",
			source:      "Испытание.com/OpenTofu/Consul/aws",
			wantString:  "Испытание.com/OpenTofu/Consul/aws",
			wantDisplay: "испытание.com/opentofu/consul/aws",
			wantNorm:    "xn--80akhbyknj4f.com/opentofu/consul/aws",
			wantErr:     false,
		},
		{
