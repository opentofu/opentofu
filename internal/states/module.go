...
// already exist.
func (ms *Module) SetResourceProvider(addr addrs.Resource, provider addrs.ConfigProviderInstance) {
	rs := ms.Resource(addr)
	if rs == nil {
		rs = &Resource{
...
func (ms *Module) SetResourceInstanceCurrent(addr addrs.ResourceInstance, obj *ResourceInstanceObjectSrc, provider addrs.ConfigProviderInstance) {
	rs := ms.Resource(addr.Resource)
...
func (ms *Module) SetResourceInstanceDeposed(addr addrs.ResourceInstance, key DeposedKey, obj *ResourceInstanceObjectSrc, provider addrs.ConfigProviderInstance) {
	ms.SetResourceProvider(addr.Resource, provider)
