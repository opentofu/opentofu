...
provider "Registry.opentf.org/example/example" { # ERROR: Non-normalized provider source address
...
provider "registry.opentf.org/-/null" { # ERROR: Invalid provider source address
}
