...
func TestPackageHashAuthentication_failure(t *testing.T) {
	tests := map[string]struct {
		...
		"checksum mismatch": {
			PackageLocalDir("testdata/filesystem-mirror/registry.opentf.org/hashicorp/null/2.0.0/linux_amd64"),
			"provider package doesn't match the expected checksum \"h1:invalid\"",
		},
		"invalid zip file": {
			PackageLocalArchive("testdata/filesystem-mirror/registry.opentf.org/hashicorp/null/terraform-provider-null_2.1.0_linux_amd64.zip"),
