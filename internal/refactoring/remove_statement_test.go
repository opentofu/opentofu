...
func TestGetEndpointsToRemove(t *testing.T) {
	tests := []struct {
		name        string
		fixtureName string
		want        []addrs.DestroyableConfigRemovable
		wantError   string
	}{
		{
			name:        "Valid cases",
			...
			want: []addrs.DestroyableConfigRemovable{
				{ConfigRemovable: interface{}(mustConfigResourceAddr("foo.basic_resource")).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(addrs.Module{"basic_module"}).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(mustConfigResourceAddr("module.child.foo.removed_resource_from_root_module")).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(mustConfigResourceAddr("module.child.foo.removed_resource_from_child_module")).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(addrs.Module{"child", "removed_module_from_child_module"}).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(mustConfigResourceAddr("module.child.module.grandchild.foo.removed_resource_from_grandchild_module")).(addrs.ConfigRemovable)},
				{ConfigRemovable: interface{}(addrs.Module{"child", "grandchild", "removed_module_from_grandchild_module"}).(addrs.ConfigRemovable)},
			},
			wantError: ``,
		},
		{
