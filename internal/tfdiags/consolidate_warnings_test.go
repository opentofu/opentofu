...
func TestConsolidateWarnings(t *testing.T) {
	...
	got := diags.Consolidate(2, Warning, DefaultDiagnosticsConsolidation, ConsolidationOptDefault).ForRPC()
	want := Diagnostics{
		// First set
		&rpcFriendlyDiag{
			Severity_: Warning,
...
func TestConsolidateError(t *testing.T) {
	...
	got := diags.Consolidate(1, Error, DefaultDiagnosticsConsolidation, ConsolidationOptDefault).ForRPC()
	want := Diagnostics{
		&rpcFriendlyDiag{
			Severity_: Error,
			Summary_:  "Error 1",
