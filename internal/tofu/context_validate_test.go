...
func TestContext2Validate_targetedDestroy(t *testing.T) {
	...
	testSetResourceInstanceCurrent(root, "aws_instance.foo", `{"id":"i-bcd345"}`, `provider["registry.opentf.org/hashicorp/aws"]`)
	testSetResourceInstanceCurrent(root, "aws_instance.bar", `{"id":"i-abc123"}`, `provider["registry.opentf.org/hashicorp/aws"]`)
