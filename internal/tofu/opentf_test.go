...
aws_instance.bar:
  ID = foo
  provider = provider["registry.opentf.org/hashicorp/aws"].bar
  foo = bar
  type = aws_instance
aws_instance.foo:
  ID = foo
...
another_instance.bar:
  ID = foo
  provider = provider["registry.opentf.org/hashicorp/another"].two
  type = another_instance
another_instance.foo:
  ID = foo
  provider = provider["registry.opentf.org/hashicorp/another"]
  type = another_instance
`
...
do_instance.foo:
  ID = foo
  provider = provider["registry.opentf.org/hashicorp/do"]
  num = 2
  type = do_instance
`
...
module.child:
  aws_instance.foo:
    ID = foo
    provider = module.child.provider["registry.opentf.org/hashicorp/aws"].eu
    type = aws_instance
`
