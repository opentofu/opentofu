...
aws_instance.bar:
  ID = foo
  provider = provider["registry.opentofu.org/opentofu/aws"].bar
  foo = bar
  type = aws_instance
aws_instance.foo:
  ID = foo
...
another_instance.bar:
  ID = foo
  provider = provider["registry.opentofu.org/opentofu/another"].two
  type = another_instance
another_instance.foo:
  ID = foo
  provider = provider["registry.opentofu.org/opentofu/another"]
  type = another_instance
`
...
do_instance.foo:
  ID = foo
  provider = provider["registry.opentofu.org/opentofu/do"]
  num = 2
  type = do_instance
`
...
module.child:
  aws_instance.foo:
    ID = foo
    provider = module.child.provider["registry.opentofu.org/opentofu/aws"].eu
    type = aws_instance
`
