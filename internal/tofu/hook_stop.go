...
func (h *stopHook) PreApplyForget(addr addrs.AbsResourceInstance) (HookAction, error) {
	return h.hook()
}

func (h *stopHook) PostApplyForget(addr addrs.AbsResourceInstance) (HookAction, error) {
	return h.hook()
}
