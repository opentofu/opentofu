...
var (
	...
	_ GraphNodeProviderInstanceConsumer      = (*NodeDestroyDeposedResourceInstanceObject)(nil)
...
var (
	...
	_ GraphNodeProviderInstanceConsumer      = (*NodeForgetDeposedResourceInstanceObject)(nil)
