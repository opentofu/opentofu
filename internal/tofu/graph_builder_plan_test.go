...
provider["registry.opentofu.org/opentofu/test"] (close)
  test_thing.c (expand)
root
  provider["registry.opentofu.org/opentofu/test"] (close)
test_thing.a (expand)
...
func TestPlanGraphBuilder_targetModule(t *testing.T) {
	...
	testGraphNotContains(t, g, `module.child1.provider["registry.opentofu.org/opentofu/test"]`)
...
openstack_floating_ip.random (expand)
  provider["registry.opentofu.org/opentofu/openstack"]
...
provider["registry.opentofu.org/opentofu/aws"] (close)
  aws_load_balancer.weblb (expand)
provider["registry.opentofu.org/opentofu/openstack"]
provider["registry.opentofu.org/opentofu/openstack"] (close)
  openstack_floating_ip.random (expand)
root
  output.instance_id (expand)
  provider["registry.opentofu.org/opentofu/aws"] (close)
