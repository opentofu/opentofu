...
terraform {
  required_providers {
    test = {
      source = "registry.opentf.org/hashicorp/test"
	}
  }
}
...
`,
  ...
  module.moda.provider["registry.opentf.org/hashicorp/test"]
module.moda.provider["registry.opentf.org/hashicorp/test"]
module.moda.test_object.a
  module.moda.provider["registry.opentf.org/hashicorp/test"]
module.moda.test_object.x
  provider["registry.opentf.org/hashicorp/test"].z
provider["registry.opentf.org/hashicorp/test"].z`
...
`})
	...
	expected := `provider["registry.opentf.org/hashicorp/test"]`
...
aws_instance.web
  provider["registry.opentf.org/hashicorp/aws"]
provider["registry.opentf.org/hashicorp/aws"]
provider["registry.opentf.org/hashicorp/aws"] (close)
  aws_instance.web
  provider["registry.opentf.org/hashicorp/aws"]
`
...
aws_instance.web
  provider["registry.opentf.org/hashicorp/aws"]
foo_instance.web
  provider["registry.opentf.org/hashicorp/foo"]
provider["registry.opentf.org/hashicorp/aws"]
provider["registry.opentf.org/hashicorp/aws"] (close)
  aws_instance.web
  provider["registry.opentf.org/hashicorp/aws"]
provider["registry.opentf.org/hashicorp/foo"]
provider["registry.opentf.org/hashicorp/foo"] (close)
  foo_instance.web
  provider["registry.opentf.org/hashicorp/foo"]
`
...
module.sub.module.subsub.bar_instance.two
  provider["registry.opentf.org/hashicorp/bar"]
module.sub.module.subsub.foo_instance.one
  module.sub.provider["registry.opentf.org/hashicorp/foo"]
module.sub.provider["registry.opentf.org/hashicorp/foo"]
provider["registry.opentf.org/hashicorp/bar"]
`
