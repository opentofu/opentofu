...
// address.
func (e *Evaluator) Scope(data lang.Data, self addrs.Referenceable, source addrs.Referenceable, parseRef lang.ParseRef, functions *ProviderFunctions) *lang.Scope {
	if functions == nil {
