...
// address.
func (e *Evaluator) Scope(data lang.Data, self addrs.Referenceable, source addrs.Referenceable, functions lang.ProviderFunky) *lang.Scope {
	return &lang.Scope{
		Data:          data,
