...
type EvalContext interface {
	...
	InitProvider(addr addrs.AbsProviderInstance, key addrs.InstanceKey) (providers.Interface, error)
	...
	Provider(addrs.AbsProviderInstance, addrs.InstanceKey) providers.Interface
	...
	// This method expects an _absolute_ provider configuration address, since
	// resources in one module are able to use providers from other modules.
	ProviderSchema(context.Context, addrs.AbsProviderInstance) (providers.ProviderSchema, error)
	...
	// This method will panic if the module instance address of the given
	// provider configuration does not match the Path() of the EvalContext.
	ConfigureProvider(addrs.AbsProviderInstance, addrs.InstanceKey, cty.Value) tfdiags.Diagnostics
