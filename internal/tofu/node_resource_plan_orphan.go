...
var (
	...
	_ GraphNodeProviderInstanceConsumer = (*NodePlannableResourceInstanceOrphan)(nil)
)
...
func (n *NodePlannableResourceInstanceOrphan) ProvidedBy() (addr addrs.LocalOrAbsProvider, exact bool) {
