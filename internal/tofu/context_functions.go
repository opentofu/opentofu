...
// Concurrency safe
func lazyProviderInstance(factory providers.Factory) providers.Factory {
...
func providerFunctions(funcSpecs map[string]providers.FunctionSpec, factory providers.Factory) map[string]function.Function {
	lazy := lazyProviderInstance(factory)
