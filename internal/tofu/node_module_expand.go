...
func (n *nodeExpandModule) Execute(ctx context.Context, evalCtx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
	...
	for _, module := range expander.ExpandModule(n.Addr.Parent()) {
		...
		case n.ModuleCall.ForEach != nil:
			forEach, feDiags := evaluateForEachExpression(ctx, n.ModuleCall.ForEach, evalCtx, module, false)
		...
		case n.ModuleCall.Enabled != nil:
			enabled, enDiags := evaluateEnabledExpression(ctx, n.ModuleCall.Enabled, evalCtx, false)
...
func (n *nodeValidateModule) Execute(ctx context.Context, evalCtx EvalContext, op walkOperation) (diags tfdiags.Diagnostics) {
	...
	for _, module := range expander.ExpandModule(n.Addr.Parent()) {
		...
		case n.ModuleCall.ForEach != nil:
			...
			_, forEachDiags := evaluateForEachExpressionValue(ctx, n.ModuleCall.ForEach, evalCtx, unknownsAllowed, tupleNotAllowed, module, false)
