...
func TestCloud_showMissingRun(t *testing.T) {
	...
	_, err := b.ShowPlanForRun(context.Background(), absentRunID, "app.opentofu.org", true)
...
func TestCloud_showMissingUnredactedJson(t *testing.T) {
	...
	redacted, err := b.ShowPlanForRun(ctx, runID, "app.opentofu.org", true)
	if err != nil {
	...
	_, err = b.ShowPlanForRun(ctx, runID, "app.opentofu.org", false)
	if err == nil {
...
func TestCloud_showIncludesUnredactedJson(t *testing.T) {
	...
	unredacted, err := b.ShowPlanForRun(ctx, runID, "app.opentofu.org", false)
	if err != nil {
