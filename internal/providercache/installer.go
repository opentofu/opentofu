...
//nolint:gocognit // this function needs further reorganization, but we're deferring that for later
...
//nolint:cyclop,funlen,gocognit,gocyclo // this function needs further decomposition, but we're deferring that for later
