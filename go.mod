...
require (
	...
	github.com/opentofu/libregistry v0.0.0-20241120120234-38c03f5d6263 // indirect
...
replace github.com/hashicorp/terraform-svchost v0.1.1 => github.com/apparentlymart/terraform-svchost v0.0.0-20241119224647-a69d4769cc49
