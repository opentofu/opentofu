...
copyright:
	curl -fsSL https://raw.githubusercontent.com/opentofu/scripts/copyright-workflow-bash/sh/copyright_check.sh | bash -s -- "" "*.go *.proto" "*/.git* */vendor/* */node_modules/* */.workdir* */website/* */tfplugin*.proto"
